function preload() {
  ...
  function create() {
    ...
    platforms.create(675, 600, 'platform');
  
    gameState.scoreText = this.add.text(400, 575, 'Score: 0', { fontSize: '15px', fill: '#000000' })
    ...
    this.physics.add.collider(gameState.player, bugs, () => {
        ...
        bugGenLoop2.destroy();
        this.physics.pause();
        this.add.text(300, 250, 'GAME OVER', { fontSize: '50px', fill: '#FF0000' });
        this.add.text(350, 300, 'Click to Restart', { fontSize: '15px', fill: '#000000' });
